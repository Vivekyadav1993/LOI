...
public class BusinessHourFrag extends HelperFrags implements CompoundButton.OnCheckedChangeListener , HttpresponseUpd {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle.getString("src").equals("def")){
          ...
          /*  if (LandingActivity.business_data.getRegularevent_flag().equals("")){
            ...
            // date end
            if (LandingActivity.business_data.getAdderess_data().get(bundle.getInt("pos")).getDate_end().equals("")||LandingActivity.business_data.getAdderess_data().get(bundle.getInt("pos")).getDate_end().equals("null")){
    ...
    void goNext(){
        ...
        if (bh_date_switch_btn.isChecked()){
            ...
            LandingActivity.business_data.getAdderess_data().get(pos).setDate_start(bh_date_start_btn.getText().toString());
            LandingActivity.business_data.getAdderess_data().get(pos).setDate_end(bh_date_start_btn.getText().toString());
        }
